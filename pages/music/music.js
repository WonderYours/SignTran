...
Page({
  data: {
    mush:[
      { dataUrl: 'http://wwa.chuanyuefengxinzi.xyz/wav/oges/1680970052.mp3', title: '众声#172387', coverImgUrl: 'https://s1.ax1x.com/2023/06/07/pCFz1Ig.jpg', name:'音声简介制作人：声音大师，治愈的女声，可以带给你温暖的力量' }
    ],
    number:'0',
    interval:'',
    widthx:'0',
    ...
    wx.request({  
      ...
      success(res) {  
        ...
        that.setData({  
          ...
          message1: res.data[1].content,
          time1:res.data[1].created,
          user1:res.data[1].author.username,
          like1:res.data[1].likes,
          message2: res.data[2].content,
          time2:res.data[2].created,
          user2:res.data[2].author.username,
          like2:res.data[2].likes,
